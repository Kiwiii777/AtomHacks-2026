public class Ship {
    ...
    // ── Upgrade cost for an attribute level ──────────
    public static int upgradeCost(String attr, int currentLevel) {
        int base;
        switch (attr) {
            case "speed":            base = 500;    break;
            case "thrust":           base = 400;    break;
            case "capacity":         base = 600;    break;
            case "miningSpeed":      base = 800;    break;
            case "miningMultiplier": base = 1200;   break;
            default:                 base = 500;
        }
        return base * currentLevel; // cost scales with current level
    }
    ...
    public static Ship[] getCatalog() {
        return new Ship[]{
            ...
            // ─ Mothership (one, always at Earth) ─
